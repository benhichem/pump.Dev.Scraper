            ...
            try {
                ...
                if (newTokens.length > 0) {
                    ...
                    if (unseen.length === 0) {
                        ...
                        const walletResult = await CollectWalletsInfo(unseen, browser);

                        if (!walletResult.success) {
                            if (walletResult.error.type === 'NotLoggedIn') {
                                console.error([
                                    '',
                ...
                console.error('[MONITOR] Iteration error, continuing:', (iterErr as Error).message);
                await Bun.sleep(5000);
            }
        }
